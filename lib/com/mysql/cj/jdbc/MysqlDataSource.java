...
JdbcPropertySet {
    ...
    public void setCustomCharsetMapping(String string) throws SQLException {
        this.setStringRuntimeProperty("customCharsetMapping", string);
    }
    ...
    public void setTrackSessionState(boolean bl) throws SQLException {
        this.setBooleanRuntimeProperty("trackSessionState", bl);
    }
    ...
    public void setPassword1(String string) throws SQLException {
        this.setStringRuntimeProperty("password1", string);
    }
    ...
    public void setPassword2(String string) throws SQLException {
        this.setStringRuntimeProperty("password2", string);
    }
    ...
    public void setOciConfigFile(String string) throws SQLException {
        this.setStringRuntimeProperty("ociConfigFile", string);
    }
    ...
    public void setPassword3(String string) throws SQLException {
        this.setStringRuntimeProperty("password3", string);
    }
