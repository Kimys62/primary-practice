...
implements JdbcPreparedStatement {
    ...
    public ResultSet executeQuery() throws SQLException {
        try {
            ...
            synchronized (object) {
                ...
                JdbcConnection locallyScopedConn = this.connection;
                if (!this.doPingInstead && (queryReturnType = this.getParseInfo().getQueryReturnType()) != QueryReturnType.PRODUCES_RESULT_SET && queryReturnType != QueryReturnType.MAY_PRODUCE_RESULT_SET) {
    ...
    protected long executeUpdateInternal(QueryBindings<?> bindings, boolean isReallyBatch) throws SQLException {
        try {
            ...
            synchronized (object) {
                ...
                if (!this.isNonResultSetProducingQuery()) {
    ...
    public String getPreparedSql() {
        ...
        synchronized (object) {
            ...
            try {
                return this.getParseInfo().getSqlForBatch();
            }
