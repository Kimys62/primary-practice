...
extends IterateBlock<String> {
    ...
    DatabaseMetaData.5(DatabaseMetaData.IteratorWithCleanup i, String string, ArrayList arrayList) {
    ...
    void forEach(String dbStr) throws SQLException {
        ...
        try {
            fkresults = DatabaseMetaData.this.extractForeignKeyFromCreateTable(dbStr, this.val$table);
            while (fkresults.next()) {
                ...
                while (commentTokens.hasMoreTokens()) {
                    ...
                    DatabaseMetaData.this.populateKeyResults(dbStr, this.val$table, keysComment, this.val$rows, null, false);
                }
            }
        }
        finally {
