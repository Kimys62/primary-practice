    ...
    public <T extends Source> T getSource(Class<T> clazz) throws SQLException {
        try {
            ...
            if (clazz.equals(StAXSource.class)) {
                try {
                    return (T)new StAXSource(this.inputFactory.createXMLStreamReader(this.fromResultSet ? this.owningResultSet.getCharacterStream(this.columnIndexOfXml) : new StringReader(this.stringRep)));
                }
