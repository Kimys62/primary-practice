...
public static final class MysqlxResultset.FetchDoneMoreResultsets
...
implements MysqlxResultset.FetchDoneMoreResultsetsOrBuilder {
    ...
    private MysqlxResultset.FetchDoneMoreResultsets(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }

    private MysqlxResultset.FetchDoneMoreResultsets() {
    }
    ...
    private MysqlxResultset.FetchDoneMoreResultsets(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Resultset_FetchDoneMoreResultsets_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxResultset.FetchDoneMoreResultsets.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MysqlxResultset.FetchDoneMoreResultsets)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MysqlxResultset.FetchDoneMoreResultsets.getDescriptor().hashCode();
    ...
    public static MysqlxResultset.FetchDoneMoreResultsets parseFrom(InputStream input) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxResultset.FetchDoneMoreResultsets parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxResultset.FetchDoneMoreResultsets parseDelimitedFrom(InputStream input) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxResultset.FetchDoneMoreResultsets parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxResultset.FetchDoneMoreResultsets parseFrom(CodedInputStream input) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input);
    }
    ...
    public static MysqlxResultset.FetchDoneMoreResultsets parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchDoneMoreResultsets)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public Builder newBuilderForType() {
        return MysqlxResultset.FetchDoneMoreResultsets.newBuilder();
    }
    ...
    public static Builder newBuilder(MysqlxResultset.FetchDoneMoreResultsets prototype) {
