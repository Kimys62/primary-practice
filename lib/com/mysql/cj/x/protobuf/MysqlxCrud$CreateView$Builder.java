...
public static final class MysqlxCrud.CreateView.Builder
extends GeneratedMessageV3.Builder<MysqlxCrud.CreateView.Builder>
implements MysqlxCrud.CreateViewOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Crud_CreateView_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxCrud.CreateView.class, MysqlxCrud.CreateView.Builder.class);
    }

    private MysqlxCrud.CreateView.Builder() {
        this.maybeForceBuilderInitialization();
    }

    private MysqlxCrud.CreateView.Builder(GeneratedMessageV3.BuilderParent parent) {
        super(parent);
        this.maybeForceBuilderInitialization();
    }
    ...
    public MysqlxCrud.CreateView build() {
        ...
        if (!result.isInitialized()) {
            throw MysqlxCrud.CreateView.Builder.newUninitializedMessageException((Message)result);
        }
        return result;
    }

    public MysqlxCrud.CreateView buildPartial() {
        MysqlxCrud.CreateView result = new MysqlxCrud.CreateView(this, null);
