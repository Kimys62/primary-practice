...
public static final class MysqlxPrepare.Execute.Builder
extends GeneratedMessageV3.Builder<MysqlxPrepare.Execute.Builder>
implements MysqlxPrepare.ExecuteOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Prepare_Execute_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxPrepare.Execute.class, MysqlxPrepare.Execute.Builder.class);
    }

    private MysqlxPrepare.Execute.Builder() {
        this.maybeForceBuilderInitialization();
    }

    private MysqlxPrepare.Execute.Builder(GeneratedMessageV3.BuilderParent parent) {
        super(parent);
        this.maybeForceBuilderInitialization();
    }
    ...
    public MysqlxPrepare.Execute build() {
        ...
        if (!result.isInitialized()) {
            throw MysqlxPrepare.Execute.Builder.newUninitializedMessageException((Message)result);
        }
        return result;
    }

    public MysqlxPrepare.Execute buildPartial() {
        MysqlxPrepare.Execute result = new MysqlxPrepare.Execute(this, null);
