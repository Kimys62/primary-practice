...
implements MysqlxCrud.ModifyViewOrBuilder {
    ...
    private MysqlxCrud.ModifyView(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }

    private MysqlxCrud.ModifyView() {
        this.definer_ = "";
        this.algorithm_ = 1;
        this.security_ = 1;
        this.check_ = 1;
    ...
    private MysqlxCrud.ModifyView(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Crud_ModifyView_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxCrud.ModifyView.class, Builder.class);
    }
    ...
    public int getSerializedSize() {
        ...
        int dataSize = 0;
        for (int i = 0; i < this.column_.size(); ++i) {
            dataSize += MysqlxCrud.ModifyView.computeStringSizeNoTag((Object)this.column_.getRaw(i));
        }
        size += dataSize;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MysqlxCrud.ModifyView)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MysqlxCrud.ModifyView.getDescriptor().hashCode();
        if (this.hasCollection()) {
            hash = 37 * hash + 1;
    ...
    public static MysqlxCrud.ModifyView parseFrom(InputStream input) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxCrud.ModifyView parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxCrud.ModifyView parseDelimitedFrom(InputStream input) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxCrud.ModifyView parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxCrud.ModifyView parseFrom(CodedInputStream input) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input);
    }
    ...
    public static MysqlxCrud.ModifyView parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxCrud.ModifyView)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public Builder newBuilderForType() {
        return MysqlxCrud.ModifyView.newBuilder();
    }
    ...
    public static Builder newBuilder(MysqlxCrud.ModifyView prototype) {
