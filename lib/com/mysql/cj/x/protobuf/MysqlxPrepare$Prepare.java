...
public static final class MysqlxPrepare.Prepare
...
implements MysqlxPrepare.PrepareOrBuilder {
    ...
    private MysqlxPrepare.Prepare(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }

    private MysqlxPrepare.Prepare() {
    }
    ...
    private MysqlxPrepare.Prepare(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Prepare_Prepare_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxPrepare.Prepare.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MysqlxPrepare.Prepare)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MysqlxPrepare.Prepare.getDescriptor().hashCode();
        if (this.hasStmtId()) {
            hash = 37 * hash + 1;
    ...
    public static MysqlxPrepare.Prepare parseFrom(InputStream input) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxPrepare.Prepare parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxPrepare.Prepare parseDelimitedFrom(InputStream input) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxPrepare.Prepare parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxPrepare.Prepare parseFrom(CodedInputStream input) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input);
    }
    ...
    public static MysqlxPrepare.Prepare parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxPrepare.Prepare)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public Builder newBuilderForType() {
        return MysqlxPrepare.Prepare.newBuilder();
    }
    ...
    public static Builder newBuilder(MysqlxPrepare.Prepare prototype) {
