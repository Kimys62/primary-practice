...
public static final class MysqlxResultset.FetchSuspended
...
implements MysqlxResultset.FetchSuspendedOrBuilder {
    ...
    private MysqlxResultset.FetchSuspended(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }

    private MysqlxResultset.FetchSuspended() {
    }
    ...
    private MysqlxResultset.FetchSuspended(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Resultset_FetchSuspended_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxResultset.FetchSuspended.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MysqlxResultset.FetchSuspended)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MysqlxResultset.FetchSuspended.getDescriptor().hashCode();
        this.memoizedHashCode = hash = 29 * hash + this.unknownFields.hashCode();
        return hash;
    }

    public static MysqlxResultset.FetchSuspended parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
        return (MysqlxResultset.FetchSuspended)PARSER.parseFrom(data);
    }
    ...
    public static MysqlxResultset.FetchSuspended parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        return (MysqlxResultset.FetchSuspended)PARSER.parseFrom(data, extensionRegistry);
    }
    ...
    public static MysqlxResultset.FetchSuspended parseFrom(InputStream input) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxResultset.FetchSuspended parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxResultset.FetchSuspended parseDelimitedFrom(InputStream input) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxResultset.FetchSuspended parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxResultset.FetchSuspended parseFrom(CodedInputStream input) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input);
    }
    ...
    public static MysqlxResultset.FetchSuspended parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxResultset.FetchSuspended)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public Builder newBuilderForType() {
        return MysqlxResultset.FetchSuspended.newBuilder();
    }
    ...
    public static Builder newBuilder(MysqlxResultset.FetchSuspended prototype) {
