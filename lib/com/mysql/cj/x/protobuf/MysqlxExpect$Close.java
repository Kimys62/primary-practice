...
public static final class MysqlxExpect.Close
...
implements MysqlxExpect.CloseOrBuilder {
    ...
    private MysqlxExpect.Close(GeneratedMessageV3.Builder<?> builder) {
        super(builder);
    }

    private MysqlxExpect.Close() {
    }
    ...
    private MysqlxExpect.Close(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        this();
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
        return internal_static_Mysqlx_Expect_Close_fieldAccessorTable.ensureFieldAccessorsInitialized(MysqlxExpect.Close.class, Builder.class);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MysqlxExpect.Close)) {
    ...
    public int hashCode() {
        ...
        int hash = 41;
        hash = 19 * hash + MysqlxExpect.Close.getDescriptor().hashCode();
    ...
    public static MysqlxExpect.Close parseFrom(InputStream input) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input);
    }

    public static MysqlxExpect.Close parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxExpect.Close parseDelimitedFrom(InputStream input) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input);
    }
    ...
    public static MysqlxExpect.Close parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseDelimitedWithIOException(PARSER, (InputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public static MysqlxExpect.Close parseFrom(CodedInputStream input) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input);
    }
    ...
    public static MysqlxExpect.Close parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
        return (MysqlxExpect.Close)GeneratedMessageV3.parseWithIOException(PARSER, (CodedInputStream)input, (ExtensionRegistryLite)extensionRegistry);
    }

    public Builder newBuilderForType() {
        return MysqlxExpect.Close.newBuilder();
    }
    ...
    public static Builder newBuilder(MysqlxExpect.Close prototype) {
